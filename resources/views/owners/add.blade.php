...
@section('title', 'Add Owner - Express Delivery PRO')
                    ...
                    <div class="row g-32">
                        <div class="col-12">
                            <div class="p-16 p-sm-24">
                                <h4 class="mb-24 text-black-80 hp-text-color-dark-0">Add Owner</h4>
                                ...
                                <form action="{{route('owner.store')}}" method="POST">
                                    ...
                                    <div class="row mt-16">
                                        <div class="form-check form-switch p-10">
                                            ...
                                            <input class="form-check-input" name="status" value="1" type="checkbox" id="status" {{ old('status') == 1 ? "checked" : "" }} checked>
